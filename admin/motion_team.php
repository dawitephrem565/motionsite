<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $descr=$row["member_descr"];
         $photo=$row["member_photo"];
         $position=$row["member_postion"];
       ...
       <div class="card-body">
         ...
         <a href="update_data/update_team.php?id='.$id.'&&src='.$photo.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into  team_members (member_name,member_descr,member_photo,member_postion,Date) value('$title_upload','$description','$file_path','$member_postion',now())") or die('<script> alert('.mysqli_error().')</script>"');
