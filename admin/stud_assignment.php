<?php
 ...
 $result=mysqli_query($con,"SELECT * from assignment  ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
  ...
  <div class="card-body">
    ...
    <a href="assignment_submit.php?file='.$document_course_file_update.'&id='.$document_id.'&course_year='.$document_course_year_update.'&department='.$document_course_dep_update.'&level='.$document_level.'&course_name='.$document_course_name_update.'&program='.$document_program.'&teacher_email='.$teacher_email.'" class="btn btn-primary">Re Submit</a>
