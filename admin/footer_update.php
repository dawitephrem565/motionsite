...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from footer where id=$id ");
 
 while($row=mysqli_fetch_assoc($result))
 {   
         $photo_update= $row["sponser_image"];
        $title_update=$row["sponser_title"];
...
if($file_upload_btn)
{
    $title = $_POST['sponser_title'];
    $file_name=$_FILES['file_name']['name'];
    move_uploaded_file($_FILES['file_name']['tmp_name'] , "File/$file_name");
    $file_path="File/$file_name";
    mysqli_query($con,"UPDATE footer set  sponser_title='$title',sponser_image='$file_path' where id=$id") or die(mysqli_error());
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col">
                  <label for="staticEmail" class="col-lg-12 col-form-label">Partner_Name</label>
                  <div class="col-sm-10">
