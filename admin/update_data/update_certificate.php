...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from  certificate where id=$id ");
 
 while($row=mysqli_fetch_assoc($result))
 {
     
    
         $photo_update= $row["certficate_image"];
        $title_update=$row["certficate_title"];
         $desc_update=$row["certificate_desc"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE certificate set certficate_title='$title',certificate_desc='$descr',certficate_image='$file_path' where id=$id") or die(mysqli_error());
