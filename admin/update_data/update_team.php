...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from  team_members where id=$id ");
 
 while($row=mysqli_fetch_assoc($result))
 {
     
    
         $photo_update= $row["member_photo"];
        $title_update=$row["member_name"];
         $desc_update=$row["member_descr"];
         $postion_update=$row["member_postion"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE  team_members set member_name='$title',member_descr='$descr',member_photo='$file_path',member_postion='$postion' where id=$id") or die(mysqli_error());
    header("location: ../motion_team.php");
    exit;
}
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col">
                  <label for="staticEmail" class="col-lg-12 col-form-label">Member name</label>
                  <div class="col-sm-10">
              ...
              <div class="row">
                <div class="col">
                  <label for="staticEmail" class="col-lg-12 col-form-label">Member Postion</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="postion" value="<?php echo $postion_update?>" id="">
                    </div>
                 </div>
