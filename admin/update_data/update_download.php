...
$id= $_REQUEST['id'];
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $src_update= $row["file_src"];
        $title_update=$row["file_name"];
         $desc_update=$row["file_descr"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE  files set file_name='$title',file_descr='$descr',file_src='$file_path' where id=$id") or die(mysqli_error());
    header("location: ../motion_download.php");
    exit;
}
