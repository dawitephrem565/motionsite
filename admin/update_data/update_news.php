...
$id= $_REQUEST['id'];
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $photo_update= $row["news_image"];
        $title_update=$row["news_title"];
         $desc_update=$row["news_descr"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE news set news_title='$title',news_descr='$descr',news_image='$file_path' where id=$id") or die(mysqli_error());
