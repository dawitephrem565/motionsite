...
$id= $_REQUEST['id'];
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $photo_update= $row["event_img"];
        $title_update=$row["event_name"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE  gallery set event_name='$title',event_img='$file_path' where id=$id") or die(mysqli_error());
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Update Gallery  </h1>
          <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col">
                  <label for="staticEmail" class="col-lg-12 col-form-label">Event Name</label>
                  <div class="col-sm-10">
              ...
              <div hidden class="col">
                  ...
                  <div class="col-sm-10">
                  <textarea hidden id="editor1" name="editor1" rows="10" cols="80">
