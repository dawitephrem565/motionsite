...
$id= $_REQUEST['id'];
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $title_update=$row["projects_title"];
         $desc_update=$row["project_desc"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE projects set projects_title='$title',project_desc='$descr' where id=$id") or die(mysqli_error());
