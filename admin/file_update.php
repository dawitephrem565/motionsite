...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from file where id=$id ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $document_course_dep_update=$row["course_dep"];
         ...
         $document_course_file_update=$row["file_path"];
         //=$row["Date"];
...
if($file_upload_btn)
{
    ...
    $file_level=$_POST['level'];
    $file_program=$_POST['program'];
    $file_name=$_FILES['file_name']['name'];
    move_uploaded_file($_FILES['file_name']['tmp_name'] , "File/$file_name");
    $file_path="File/$file_name";
    mysqli_query($con,"UPDATE file set course_dep='$file_course_dep',course_name='$file_course_name',course_year='$file_course_year',file_path='$file_path',level='$file_level',program='$file_program' where id=$id") or die(mysqli_error());
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">File Uploaded</h1>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php echo " <option >$document_course_year_update</option> " ?>
