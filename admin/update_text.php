...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from price where id=$id ");
...
if($document)
{
    ...
    mysqli_query($con,"UPDATE price set title='$update_text',price='$update_price' where id=$id") or die(mysqli_error());
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" >
            <div class="row">
              <div class="col">
                <label for="staticEmail" class="col-lg-12 col-form-label">Type</label>
                <div class="col-sm-10">
                   
                  <input type="text" class="form-control" name="title" value="<?php echo $title?>" id="">
               </div>
              <div class="col">
                <label for="inputPassword" class="col-lg-12 col-form-label">Price</label>
                <div class="col-sm-10">
                 <input type="text" class="form-control" name="price" value="<?php echo $price?>" id="">
                </div> </div>
                <div class="col">
                  <hr>
                <div class="col-sm-10">
