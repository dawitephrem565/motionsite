...
$id= $_REQUEST['id'];
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $photo_update= $row["image"];
        $title_update=$row["UserName"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE founders set UserName='$title',Descr='$descr',image='$file_path' where id=$id") or die(mysqli_error());
