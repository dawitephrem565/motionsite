    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Video Conference</h1>
            </div>
...
<div class="container">
         ...
         <div class="table-responsive">
          ...
          <table id="dataTables" class="table table-bordered" style="width:100%">
            ...
            $no = 1;
            $display_docu_table ="";
            $result=mysqli_query($con,"SELECT * from video_conference where  teacher_email='$teacher_email' ");
            ...
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                <tr>
                    ...
                    <td>'. $row["Date"].'</td>
                    <td><a class="btn btn-primary btn-xs" href="video_update.php?id='. $row["id"].'">Update</a></td>
                    <td><a class="btn btn-danger btn-xs" href="video_con_delete.php?id='. $row["id"].'">Delete</a></td>
