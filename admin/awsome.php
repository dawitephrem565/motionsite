<?php
 ...
 $result=mysqli_query($con,"SELECT * from awesome ");
 $display_data="";
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $id= $row["id"];
         ...
         $display_data .='<div class="card border-success mb-3" style="max-width: 18rem;">
         <div class="card-header bg-transparent border-success"></div>
         <div class="card-body text-success">
           <h5 class="card-title">'.$title.'</h5>
           <p class="card-text">'.$descr.'</p>
         </div>
         <div class="card-footer bg-transparent border-success"><a href="update_awesome.php?id='.$id.'" class="btn btn-success">Update</a></div>
       </div>';
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Div 2</h1>
            </div>
