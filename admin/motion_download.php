<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
       ...
       <div class="card-body">
         ...
         <a href="update_data/update_projects.php?id='.$id.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into files (file_name,file_descr,file_src,Date) value('$title_upload','$description','$file_path',now())") or die('<script> alert('.mysqli_error().')</script>"');
