...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from lead where id=$id ");
...
if($document)
{
    ...
    $sql =mysqli_query($con,"UPDATE lead set title='$update_text',descr='$update_descr',Image='$file_path' where id=$id") or die('<script> alert('.mysqli_error().')</script>"');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Leading </h1>
