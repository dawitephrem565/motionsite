<?php
 ...
 $result=mysqli_query($con,"SELECT * from work_flow ");
 $display_news="";
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into work_flow (flow_title,flow_number,Date) value('$title_upload','$description',now())") or die('<script> alert('.mysqli_error().')</script>"');
    header("location: motion_work_flow.php");
    exit;
}
?>
<!DOCTYPE html>
