    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Check Assignment</h1>
            </div>
         ...
         <div class="table-responsive">
          ...
          <table id="dataTables" class="table table-bordered" style="width:100%">
            <thead>
                ...
                <td>Post Date</td>
                <td>Check The post</td>
                </tr>
            </thead>
            <?php
            $no = 1;
            $display_docu_table ="";
            $result=mysqli_query($con,"SELECT * from assign_resubmit ");
            ...
            while($row=mysqli_fetch_assoc($result))
            {
               ...
               $post_doc =  $row['email'];
                ...
                <tr>
                    ...
                    <td>'. $row["Date"].'</td>
                    <td>  <a href="stud_assignment_detail.php?email='.$post_email.'&id='.$post_id.'&doc='.$post_id.'" class="btn btn-primary">Check</a>
                    </td>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Check resubmit</h5>
