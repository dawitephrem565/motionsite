<?php
 ...
 $result=mysqli_query($con,"SELECT * from assignment where teacher_email='$teacher_email'  ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
    ...
    $document_course_dep_update=$row["course_dep"];
     ...
     $document_course_file_update=$row["assignment_file"];
     $document_level=$row['level'];
     $document_program=$row['program'];
     $document_course_Date_update=$row["Date"];
     $teacher_email=$row['teacher_email'];
         
  $display_text_documnet .='<div class="card text-center">
  <div class="card-header">
   '.$document_course_dep_update.'
  </div>
  <div class="card-body">
    <h5 class="card-title">'.$document_course_name_update.'</h5>
    
    <a href="download.php?file='.$document_course_file_update.'" class="btn btn-primary">Download</a>
    <a href="stud_assignment_check_table.php?file='.$document_course_file_update.'&id='.$document_id.'&course_year='.$document_course_year_update.'&department='.$document_course_dep_update.'&level='.$document_level.'&course_name='.$document_course_name_update.'&program='.$document_program.'&teacher_email='.$teacher_email.'" class="btn btn-primary">Check Submit</a>
 
    </div>
  <div class="card-footer text-muted">
    '.$document_course_Date_update.'
  </div>
</div>
<hr>
';
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Student Assignemt </h1>
                     </div>
