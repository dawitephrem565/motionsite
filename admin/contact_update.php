<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        $id = $row["id"];
         ...
         $main_call=$row["main_call"];
         $call_information = $row["call_information"];
         $main_email = $row["main_email"];
         $mail_decr=$row["mail_decr"];
         
        $display_data .='  <div class="card" style="width: 18rem;">
        <div class="card-header">
          Location
        </div>
        <ul class="list-group list-group-flush">
          <li class="list-group-item">'.$main_area.'</li>
          <li class="list-group-item">'.$specfic_area.'</li>
        </ul>
      </div>
      &nbsp;&nbsp; 
      <div class="card" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item">'.$main_call.'</li>
          <li class="list-group-item">'.$call_information.'</li>
        </ul>
      </div>
      &nbsp;&nbsp;
      <div class="card" style="width: 18rem;">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">'.$main_email.'</li>
        <li class="list-group-item">'.$mail_decr.'</li>
        <a href="updata_contact.php?id='.$id.'" class="btn btn-success"> Update</a>
      </ul>
    </div>
    <hr>
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Contact Information</h1>
            </div>
