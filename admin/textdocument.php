          ...
          <table id="dataTables" class="table table-bordered" style="width:100%">
            ...
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                <tr>
                    ...
                    <td>'. $row["Date"].'</td>
                    <td><a class="btn btn-primary btn-xs" href="update_text.php?id='. $row["id"].'">Update</a></td>
                    <td><a class="btn btn-danger btn-xs" href="doc_delete.php?id='. $row["id"].'">Delete</a></td>
