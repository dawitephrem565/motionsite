<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
       ...
       <div class="card-body">
         ...
         <a href="update_data/update_values.php?id='.$id.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into value (title,descr,Date) value('$title_upload','$description',now())") or die('<script> alert('.mysqli_error().')</script>"');
    header("location: motion_values.php");
    exit;
}
?>
<!DOCTYPE html>
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> Values and STRATEGIES </h1>
            </div>
