<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $Descr=$row["heading_descr"];
         $photo=$row["banner_Image"];
         $id_req= $row["id"];
        $display_data= '<div class="card col-lg-8" style="width: 18rem;">
        <img class="card-img-top" src="'.$photo.'" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">'.$title.'</h5>
          <p class="card-text">'.$Descr.'</p>
          <a href="banner_update.php?id='.$id_req.'" class="btn btn-primary">Update</a>
        </div>
      </div>';
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Banner Content</h1>
            </div>
