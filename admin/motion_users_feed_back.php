<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $id = $row['id'];
         $title= $row["feed_back_name"];
         $email= $row["feed_back_email"];
         $feed_back_phone= $row["feed_back_phone"];
        $descr=$row["feed_back_message"];
       ...
       <div class="card-body">
         ...
         <p class="card-text"><small class="text-muted"> '.$feed_back_phone.' </small></p>
