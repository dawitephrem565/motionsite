...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from feature where id=$id ");
...
if($document)
{
    ...
    mysqli_query($con,"UPDATE feature set title='$update_text',descr='$update_descr' where id=$id") or die(mysqli_error());
    header("location: feauters.php");
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Update Features Content </h1>
          <form action="" method="POST" >
            <div class="row">
              ...
              <div class="col">
                ...
                <div class="col-sm-10">
                 <textarea class="form-control" name="descr" id="editor1"  rows="10" cols="80"><?php echo $decr?></textarea>
                </div> </div>
                <div class="col">
                  <hr>
                <div class="col-sm-10">
