<?php
 ...
 $result=mysqli_query($con,"SELECT * from how_we_work ");
 $display_news="";
 while($row=mysqli_fetch_assoc($result))
 {
       ...
       <div class="card-body">
         ...
         <a href="how_we_work_update.php?id='.$id.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into news (title,descr,photo,Date) value('$title_upload','$description','$file_path',now())") or die('<script> alert('.mysqli_error().')</script>"');
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> How We Work </h1>
            </div>
