<?php
 ...
 $result=mysqli_query($con,"SELECT * from video_conference  ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
  ...
  <div class="card-body">
    ...
    <p class="card-text">'.$document_course_title_update.'</p>
    <a href="'.$document_course_title_update.'" class="btn btn-primary">Join Us</a>
  </div>
