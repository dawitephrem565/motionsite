    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> Registered Voluntrism Users </h1>
            </div>
...
<th>Action</th>
        ...
        <tbody>
           ...
           <?php echo $motion->fetch_unchecked_voluntrism_request();?>
        </tbody>
...
<th>Action</th>
        ...
        <tbody>
           ...
           <?php echo $motion->fetch_checked_voluntrism_request();?>
        </tbody>
