<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
       ...
       <div class="card-body">
         ...
         <a href="update_data/update_gallary.php?id='.$id.'&&type=gallery&&src='.$photo.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into gallery (event_name,event_img,Date) value('$title_upload','$file_path',now())") or die('<script> alert('.mysqli_error().')</script>"');
