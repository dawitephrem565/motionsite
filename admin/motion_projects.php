<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $id = $row['id'];
         $title= $row["projects_title"];
        $descr=$row["project_desc"];
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into projects (projects_title,project_desc,Date) value('$title_upload','$description',now())") or die('<script> alert('.mysqli_error().')</script>"');
