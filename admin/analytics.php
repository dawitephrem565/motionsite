<?php
 ...
 $file_upload_btn = isset($_POST['file_upload_btn']);
  $result=mysqli_query($con,"SELECT * from analytics ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        <div class="card-body">
          ...
          <a href="update_analytics.php?id='.$id_req.'" class="btn btn-primary">Update</a>
        </div>
      </div>';
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Div 5</h1>
            </div>
