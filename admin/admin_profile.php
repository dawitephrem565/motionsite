...
if($_SESSION["user"]=='admin')
{
 ...
 $document = isset($_POST['update_profile']); 
 $t_email=$_SESSION['email'];
 $teacher_email=$_SESSION['email'];
 
 $result=mysqli_query($con,"SELECT * from tusers where id=1 ");
...
if($document)
{
    ...
    $lname = $_POST['lname'];
    $fname=$_POST['fname'];
    mysqli_query($con,"UPDATE tusers set fname='$fname',lname='$lname',email='$email',password='$password' where id=1") or die(mysqli_error());
    header("location: teadcher_register.php");
    exit;
}
...
<div class="container">
        ...
        <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <input class="form-control" value="<?php echo $fname_display?>" type="text" name="fname" id="fname">
                    
                <br>
                <label for="fname">  Last Name</label>
                    <input class="form-control" type="text" value="<?php echo $lname_display?>" name="lname" id="fname">
                      </div>
        </div>
        </div>
        <hr>
        <div class="row">
                ...
                <label for="fname">  Email</label>
                    <input class="form-control" type="text" value="<?php echo $email_display?>" name="email" id="fname">
                   <br>
                   <label for="fname">  Password</label>
                    <input class="form-control" type="text" value="<?php echo $password_display?>" name="password" id="fname">
                </div>
                </div>
                </div>
                <br>
