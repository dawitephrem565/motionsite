<?php
 ...
 $result=mysqli_query($con,"SELECT * from page_heading");
 $display_heading="";
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $heading_descr=$row["heading_descr"];
         $heading_id=$row["id"];
       $display_heading .='<div class="card">
       <h5 class="card-header">'.$heading_title.'</h5>
       <div class="card-body">
         <h5 class="card-title">'.$heading_title.'</h5>
         <p class="card-text">'.$heading_descr.'</p>
         <a href="heading_update.php?id='.$heading_id.'" class="btn btn-primary">Update</a>
       </div>
     </div>
     <br>
       '; 
...
if($document)
{
    ...
    mysqli_query($con,"INSERT into feauter(Course_dep,Course_name,Course_title,Course_doc,Course_year,Date) values('$course_dep','$course_name','$course_title','$course_doc','$course_year',now())") or die(mysqli_error());
