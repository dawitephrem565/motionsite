...
$id= $_REQUEST['id'];
 $display_docu_table ="";
 $result=mysqli_query($con,"SELECT * from how_we_work where id=$id ");
 
 while($row=mysqli_fetch_assoc($result))
 {
     
    
         $photo_update= $row["heading_photo"];
        $title_update=$row["heading_title"];
         $desc_update=$row["heading_descr"];
...
if($file_upload_btn)
{
    ...
    mysqli_query($con,"UPDATE how_we_work set heading_title='$title',heading_descr='$descr',heading_photo='$file_path' where id=$id") or die(mysqli_error());
    header("location: how_we_work.php");
    exit;
}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Update Div 2  Uploaded</h1>
