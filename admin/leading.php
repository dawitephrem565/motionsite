<?php
 ...
 $file_upload_btn = isset($_POST['file_upload_btn']);
  $result=mysqli_query($con,"SELECT * from lead ");
 ...
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        <div class="card-body">
          ...
          <a href="leading_update.php?id='.$id_req.'" class="btn btn-primary">Go somewhere</a>
        </div>
      </div>';
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update  Div 3</h1>
            </div>
