<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
       ...
       <div class="card-body">
         ...
         <a href="update_data/update_faq.php?id='.$id.'" class="btn btn-success">Update</a>
         </div>
     </div></div>';
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into faq (faq_title,faq_descr,Date) value('$title_upload','$description',now())") or die('<script> alert('.mysqli_error().')</script>"');
    header("location: faq_motion.php");
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div class="modal-header">
      ...
      <form action="" method="POST" enctype="multipart/form-data" >
        ...
        <hr>
            ...
            <div class="row">
              <div class="col">
                <label for="staticEmail" class="col-lg-12 col-form-label">FAQ Title</label>
                <div class="col-sm-10">
