<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
         ...
         $id = $row['id'];
         $title= $row["sponser_title"];
        
         $photo=$row["sponser_image"];
       ...
       <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <a href="footer_update.php?id='.$id.'" class="btn btn-success">Update</a>
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into footer (sponser_title,sponser_image,Date) value('$clinet_title','$file_path',now())") or die('<script> alert('.mysqli_error().')</script>"');
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sponser Images</h1>
            </div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload Sponser Image</h5>
