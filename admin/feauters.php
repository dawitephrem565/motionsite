<?php
 ...
 while($row=mysqli_fetch_assoc($result))
 {
  ...
  <div class="card-body text-success">
    <h5 class="card-title">'.$title_req.'</h5>
    <p class="card-text">'.$descr_req.'</p>
  </div>
  <div class="card-footer bg-transparent border-success"><a href="update_feauters.php?id='.$id_req.'" class="btn btn-success">Update</a></div>
</div>
       '; 
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update  Div 4</h1>
            </div>
