<?php
 ...
 $result=mysqli_query($con,"SELECT * from client_say ");
 $display_news="";
 while($row=mysqli_fetch_assoc($result))
 {
        ...
        $descr=$row["client_level"];
         $photo=$row["clients_Image"];
         $client_qoute=$row["client_qoute"];
       ...
       <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <p class="card-text">'.$client_qoute.'</p>
                <p class="card-text"><small class="text-muted">  </small></p>
                <a href="client_says_update.php?id='.$id.'" class="btn btn-success">Update</a>
                <a href="client_says_delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
...
if($document)
{
    ...
    $sql =mysqli_query($con,"insert into client_say (clients_Image,client_name,client_level,client_qoute,Date) value('$file_path','$client_name','$client_level','$description',now())") or die('<script> alert('.mysqli_error().')</script>"');
    ...
    <?php echo $head_nav;?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">CEO Messages </h1>
            </div>
        ...
        <hr>
            ...
            <div class="row">
              <div class="col">
               ...
               <div class="col">
                <label for="staticEmail" class="col-lg-12 col-form-label">Level Education</label>
                <div class="col-sm-10">
